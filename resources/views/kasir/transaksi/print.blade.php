...
<body>
    <div class="resi-container">
        <div class="resi-header">
            ...
            <h3>Toko Bengkel Sperpart</h3>
            <p>Jalan Kapasan No. 10 RT 20 RW 05,</p>
            <p>Kel. Sidokare , Kec. Sidoarjo, Kab. Sidoarjo.</p>
        </div>
        <div class="resi-details">
            <label>Tanggal transaksi : </label> <span>{{$transaksi->created_at->timezone('Asia/Jakarta')}}</span><br>
