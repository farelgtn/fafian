                ...
                <div class="card-body">
                    ...
                    <form action="/admin/transaksi/detail/create" method="POST">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-8">
                                <a href="/admin/transaksi" class="btn btn-info"><i data-feather="arrow-left"></i> Kembali</a>
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/transaksi/detail/delete?id={{$item->id}}"><i data-feather="x"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </table>

                    <a href="/admin/transaksi/detail/selesai/{{Request::segment(3)}}" class="btn btn-success"><i data-feather="check"></i> Selesai</a>
                    <a href="/admin/transaksi/detail/pending/{{Request::segment(3)}}" class="btn btn-info"><i data-feather="file"></i> Pending</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                document.getElementById('formDibayarkan').addEventListener('submit', function(event) {
                    ...
                    fetch('/admin/transaksi/{{ $transaksi->id }}/dibayarkan', {
                        method: 'POST',
                        body: formData
                    })
